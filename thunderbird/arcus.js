...
function __wbg_adapter_26(arg0, arg1, arg2) {
    wasm._dyn_core__ops__function__FnMut__A____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__hdd975d66a2977f95(arg0, arg1, addHeapObject(arg2));
}
...
function __wbg_adapter_114(arg0, arg1, arg2, arg3) {
    wasm.wasm_bindgen__convert__closures__invoke2_mut__h0e33d6a4dc413577(arg0, arg1, addHeapObject(arg2), addHeapObject(arg3));
}
...
export class Arcus {
    ...
    static __wrap(ptr) {
        const obj = Object.create(Arcus.prototype);
        obj.ptr = ptr;
    ...
    free() {
        ...
        wasm.__wbg_arcus_free(ptr);
    }
    /**
    */
    constructor() {
        const ret = wasm.arcus_new();
        return Arcus.__wrap(ret);
    }
    /**
    ...
    * @returns {string}
    */
    encrypt_text(cleartext, recipient_pubkey) {
        try {
            ...
            wasm.arcus_encrypt_text(retptr, this.ptr, ptr0, len0, ptr1, len1);
    ...
    /**
    * @param {string} cleartext
    * @param {Array<any>} recipient_pubkeys
    * @returns {string}
    */
    encrypt_text_multi(cleartext, recipient_pubkeys) {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            const ptr0 = passStringToWasm0(cleartext, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
            const len0 = WASM_VECTOR_LEN;
            wasm.arcus_encrypt_text_multi(retptr, this.ptr, ptr0, len0, addHeapObject(recipient_pubkeys));
            var r0 = getInt32Memory0()[retptr / 4 + 0];
            var r1 = getInt32Memory0()[retptr / 4 + 1];
            return getStringFromWasm0(r0, r1);
        } finally {
    ...
    * @param {string} own_secretkey
    * @returns {string}
    */
    decrypt_text(ciphertext, own_secretkey) {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            const ptr0 = passStringToWasm0(ciphertext, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
            const len0 = WASM_VECTOR_LEN;
            const ptr1 = passStringToWasm0(own_secretkey, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
            const len1 = WASM_VECTOR_LEN;
            wasm.arcus_decrypt_text(retptr, this.ptr, ptr0, len0, ptr1, len1);
            var r0 = getInt32Memory0()[retptr / 4 + 0];
            var r1 = getInt32Memory0()[retptr / 4 + 1];
            return getStringFromWasm0(r0, r1);
        } finally {
    ...
    /**
    * @returns {ArcusKeypair}
    */
    generate_key() {
        const ret = wasm.arcus_generate_key(this.ptr);
        return ArcusKeypair.__wrap(ret);
    }
    /**
    * @param {string} secret_key
    * @returns {string}
    */
    pub_from_secret(secret_key) {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            const ptr0 = passStringToWasm0(secret_key, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
            const len0 = WASM_VECTOR_LEN;
            wasm.arcus_pub_from_secret(retptr, this.ptr, ptr0, len0);
            var r0 = getInt32Memory0()[retptr / 4 + 0];
            var r1 = getInt32Memory0()[retptr / 4 + 1];
            return getStringFromWasm0(r0, r1);
        } finally {
...
/**
*/
export class ArcusKeypair {

    static __wrap(ptr) {
        const obj = Object.create(ArcusKeypair.prototype);
        obj.ptr = ptr;
    ...
    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_arcuskeypair_free(ptr);
    }
    /**
    */
    constructor() {
        const ret = wasm.arcuskeypair_new();
        return ArcusKeypair.__wrap(ret);
    }
    /**
    * @returns {string}
    */
    get_pubkey() {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.arcuskeypair_get_pubkey(retptr, this.ptr);
            var r0 = getInt32Memory0()[retptr / 4 + 0];
            var r1 = getInt32Memory0()[retptr / 4 + 1];
            return getStringFromWasm0(r0, r1);
        } finally {
    ...
    */
    get_secret() {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.arcuskeypair_get_secret(retptr, this.ptr);
            var r0 = getInt32Memory0()[retptr / 4 + 0];
            var r1 = getInt32Memory0()[retptr / 4 + 1];
            return getStringFromWasm0(r0, r1);
        } finally {
...
export class Encryptor {
    ...
    static __wrap(ptr) {
        const obj = Object.create(Encryptor.prototype);
        obj.ptr = ptr;
    ...
    * @returns {Encryptor}
    */
    static with_user_passphrase(passphrase) {
        const ptr0 = passStringToWasm0(passphrase, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.encryptor_with_user_passphrase(ptr0, len0);
        return Encryptor.__wrap(ret);
    }
}
/**
*/
...
export class X25519Identity {
    ...
    static __wrap(ptr) {
        const obj = Object.create(X25519Identity.prototype);
        obj.ptr = ptr;
    ...
    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_x25519identity_free(ptr);
    }
    /**
    * Generates a new age identity.
    * @returns {X25519Identity}
    */
    static generate() {
        const ret = wasm.x25519identity_generate();
        return X25519Identity.__wrap(ret);
    }
    /**
    ...
    */
    write() {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.x25519identity_write(retptr, this.ptr);
            var r0 = getInt32Memory0()[retptr / 4 + 0];
            var r1 = getInt32Memory0()[retptr / 4 + 1];
    ...
    */
    recipient() {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.x25519identity_recipient(retptr, this.ptr);
            var r0 = getInt32Memory0()[retptr / 4 + 0];
            var r1 = getInt32Memory0()[retptr / 4 + 1];
            return getStringFromWasm0(r0, r1);
        } finally {
...
function getImports() {
    ...
    imports.wbg.__wbg_log_d8db020df79310f3 = function(arg0, arg1) {
...
async function init(input) {
    if (typeof input === 'undefined') {
        input = new URL('arcus_bg.wasm', import.meta.url);
    }
    const imports = getImports();
